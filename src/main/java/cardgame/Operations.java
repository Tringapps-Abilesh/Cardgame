...
//creating  Arraylist for player's cards
	    ...
	    ArrayList<Card> playerFourCards = new ArrayList<Card>();
	    ArrayList<ArrayList<Card>> allPlayerCards = new ArrayList<ArrayList<Card>>();
